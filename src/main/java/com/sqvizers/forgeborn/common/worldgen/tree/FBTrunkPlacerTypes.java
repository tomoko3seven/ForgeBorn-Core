...
public class FBTrunkPlacerTypes {
    ...
    public static final DeferredRegister<TrunkPlacerType<?>> TRUNK_PLACER_TYPES = DeferredRegister
            .create(Registries.TRUNK_PLACER_TYPE, ForgeBorn.MOD_ID);

    public static final RegistryObject<TrunkPlacerType<DreamtreeTrunkPlacer>> DREAM_TRUNK_PLACER = TRUNK_PLACER_TYPES
            .register("dream_trunk_placer",
