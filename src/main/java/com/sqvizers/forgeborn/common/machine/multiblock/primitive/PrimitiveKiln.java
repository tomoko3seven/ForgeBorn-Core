...
public class PrimitiveKiln extends PrimitiveWorkableMachine implements IUIMachine {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            PrimitiveKiln.class, PrimitiveWorkableMachine.MANAGED_FIELD_HOLDER);
    ...
    public PrimitiveKiln(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    }
