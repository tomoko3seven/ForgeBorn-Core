package com.sqvizers.forgeborn.api.machines;
...
public class StrongSteamParallelMultiblockMachine extends WorkableMultiblockMachine implements IDisplayUIMachine {
    ...
    private static final double CONVERSION_RATE = 0.25D;
